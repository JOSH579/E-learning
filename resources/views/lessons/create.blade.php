...
@section('content')
    ...
    <h1 class="mb-6 text-2xl font-semibold tracking-tight">Add lesson</h1>

    <form method="POST" action="{{ route('courses.modules.lessons.store', [$course, $module]) }}" enctype="multipart/form-data" class="max-w-xl space-y-4">
        @csrf
